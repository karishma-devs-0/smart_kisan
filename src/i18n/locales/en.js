export default {
  ...
  weedDetection: {
    ...
    scan: 'Scan field',
    gallery: 'Gallery',
    previewHint: 'Photograph the crop canopy to scan it',
    analysing: 'Analysing…',
    loadingModels: 'Loading detection models…',
    cameraPermission: 'Camera access is needed to scan the field.',
    galleryPermission: 'Photo access is needed to pick an image.',
    // Results
    detected: 'Detected',
    noWeed: 'No weed detected',
    canopyHealthy: 'Canopy looks healthy',
    confidence: 'Confidence',
